        ...
        {products.map(p => (
          <div key={p.id} style={{ background:"var(--bg-card)", border:"1px solid var(--gold-border)", borderRadius:"14px", overflow:"hidden", transition:"var(--transition)" }}
            ...
            <div style={{ position:"relative" }}>
              ...
              <div style={{ position:"absolute", top:"6px", right:"6px", background:"rgba(184,150,46,0.92)", color:"#000", padding:"3px 9px", borderRadius:"6px", fontSize:"10px", fontWeight:"800" }}>🎨 صياغة حسب الطلب</div>
            </div>
